                     ...
                     <p style="font-size:15px;font-style:sans-serif;color:black;" ><B>ADMINISTRATION</B></p>
								 ...
								 <li class="active">
										<a data-toggle="tab" data-target="#add">
												...
												<p style="font-size:15px;font-style:sans-serif;color:black;" ><b>ADD DECOR'S</b></p>
										</a>
								</li>
							      <li>
                    <a data-toggle="tab" data-target="#update">
                      
                        <p style="font-size:15px;font-style:sans-serif;color:black;" ><b>UPDATE DECOR'S</b></p>
                    </a>
                </li>
       ...
       <div class="col-md-8" style="margin-left:50px;background:crimson;">
         <div class="tab-content">
                          ...
                          <div  id="add" class="tab-pane fade in active"> 
                               <jsp:include page="decoradd.html"/>
                                </div>
                                <div id="update" class="tab-pane fade">
                                <jsp:include page="decorupdate.html"/>
                                </div>
