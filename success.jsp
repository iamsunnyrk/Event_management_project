...
#btn1 {
					...
					<div id="m_nav_container" class="m_nav wthree_bg">
                                        <nav class="menu menu--sebastian">
                                                <ul id="m_nav_list" class="m_nav menu__list">
                                                        <li class="m_nav_item active" id="m_nav_item_1"> <a href="success." class="link link--kumya"><i class="fa fa-home" aria-hidden="true"></i><span data-letters="Home">Home</span></a></li>
                                                      ...
                                                      --> 
                                                       ...
                                                       <li class="m_nav_item" id="moble_nav_item_5"> <a href="profile.jsp" class="link link--kumya"  style><i class="fa fa-user" aria-hidden="true"></i><span data-letters="<%= thisUser %>"><%= thisUser %></span></a></li>
	...
	<!--  	<div class="header">
		<div class="agileits_w3layouts_logo"> 
					<h1><a href="success.jsp"><img src="SR.jpg"  class="imageborder" > </a></h1>
				</div> 
				</div> 
			...
			<ul class="slides">
				<li>
					<div class="agileits_w3layouts_banner_info">
						<blink><h3>Let professionals run your event!</h3></blink>
				...
				<div class="quicklinks-agile-info-top" id="birth">
					<div class="col-md-6 agile-info-top-left">
						<div class="w3agile_special_deals_grid_left_grid">
							<img src="images/2.jpg" class="img-responsive" alt=""><a href="book.jsp">
